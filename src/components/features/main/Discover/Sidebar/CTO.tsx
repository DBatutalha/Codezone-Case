  ...
  return (
    <div className="w-full bg-[#121212] py-12 flex flex-col mt-10  ">
      <div className="flex flex-col ">
        <h2 className="text-white text-[3.475vw] font-saira-bold uppercase mb-10 leading-10 sm:text-3xl sm:mb-6 sm:text-center max-[428px]:ml-25">
      ...
      <div className="text-[0.97vw] sm:text-base">
        <div className="flex flex-row  items-center gap-x-8 mt-10 mb-6">
          {socials.map((social, idx) => (
            <button key={idx}>{social.svg}</button>
          ))}
        </div>
        <div className="flex flex-col justify-between items-center text-white mb-4 gap-4  max-[428px]:hidden">
          <div className="flex flex-col  w-full justify-between gap-4 font-saira-normal ">
            <div className="flex flex-row justify-between sm:flex-col sm:gap-y-4  ">
        ...
        <div className="text-[#5A5A5A] text-xs font-saira-normal mt-2 text-left sm:text-center ">
